...
public class SingleWorkController extends BaseController {
     ...
     * 通过车间id查询责任人名称
     */
    @PostMapping("/findDeviceLiableByHouseId")
    @ResponseBody
    public AjaxResult findDeviceLiableByHouseId(Integer houseId){
        return AjaxResult.success(singleWorkService.findDeviceLiableByHouseId(houseId));
    }
